(function (angular, _, ds, $) {
    ...
    .controller('sendInquiryCtrl', ['$scope', '$timeout', '$q', '$location', '$routeParams', 'messenger', 'Message', 'authenticator', 'ImageInfo', function ($s, $t, $q, $l, $p, mess, Message, auth, ImageInfo) {
